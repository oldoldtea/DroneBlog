...
class BlogPost(BaseModel):
    ...
    updated: datetime | None = Field(default=None, description="更新日期")
...
class PipelineStage(BaseModel):
    ...
    timestamp: str | None = Field(default=None, description="完成时间")
...
class PipelineStatus(BaseModel):
    ...
    current_stage: str | None = Field(default=None, description="当前执行阶段")
